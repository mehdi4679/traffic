<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WizardDashboard.master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="TerraficPlan.Public.Manage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
       ...
       <table>
           ...
           <tr>
               <td>تا تاریخ</td>
               <td>
                   <uc2:CtlDatePicker ID="txtToDate" runat="server" />
           ...
           <tr  style="height:0px;">
               ...
               <td>وضعیت:</td><td colspan="10">  <%#Eval("RequestStatusName").ToString() +" "+Eval("DelStatus").ToString() %>  </td></tr>
                <tr style="height:0px;">
                    ...
                    <td class="tda" >
                             <a  href='#' data-rel="tooltip" title="اظهار نظر" data-original-title="اظهار نظر"   class="fa fa-comment" onclick="fnazar(<%#Eval("RequestTrafficID") %>)"  ></a>
...
<div id="lightinsertnazar" class="Lightbox" >
