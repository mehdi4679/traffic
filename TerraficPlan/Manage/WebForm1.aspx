<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="TerraficPlan.Manage.WebForm1" %>
<!DOCTYPE html>
<html lang="en">
		...
		<div id="navbar" class="navbar navbar-default">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="wysiwyg.html#" class="navbar-brand">
						<small>
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="grey">
							<a data-toggle="dropdown" class="dropdown-toggle" href="wysiwyg.html#">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="wysiwyg.html#" class="dropdown-toggle">
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="wysiwyg.html#" class="dropdown-toggle">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						<li>
							...
							<a href="wysiwyg.html#">Home</a>
						</li>

						<li>
							<a href="wysiwyg.html#">Forms</a>
						</li>
