...
{
    public partial class RepAfetrPamant : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                divbody.InnerHtml = divbody.InnerHtml.ToString().Replace(@"#Carname", dr["Carname"].ToString());
                divbody.InnerHtml = divbody.InnerHtml.ToString().Replace(@"#FromDate", dr["FromDate"].ToString());
