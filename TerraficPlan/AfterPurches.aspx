<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewFreeMaster.master" AutoEventWireup="true" CodeBehind="AfterPurches.aspx.cs" Inherits="TerraficPlan.AfterPurches" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
 ...
 <asp:label runat="server" id="lblRacCode" ></asp:label>
    ...
    <asp:Label runat="server" ID="lblmsg" ></asp:Label>
        <br />
        <div>
            <asp:Button runat="server" Visible="false"  ID="btnReBuy" Text="بازگشت به صفحه خربد عوارض" OnClick="btnReBuy_Click" />
