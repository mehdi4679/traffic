...
namespace TerraficPlan.New
{
    public partial class AfterPurches : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (RequestUnpack())
                {
                    ...
                    //if(1==1)
                    {
                        ...
                        if (RegMojaz != "")
                        {
                            TerraficPlanBLL.Utility.ShowMsg(Page, TerraficPlanBLL.ProPertyData.MsgType.warning, RegMojaz + " کاربر گرامی  ثبت پلاک ناموفق بود. وجه پرداختی شما تا چند دقیقه دیگر بازگشت خواهد خورد ");
                            return;
                        }
                        ...
                        lblEpayID.Text = EpayOrderID.ToString();
                        ...
                        //        lblstats.Text = "مبلغ بازگشتی معتبر نیست وعملیات خرید لغو و مبلغ عودت شد";
                            //}
                           // else
                             //{
                                isError = false;
            ...
            if(Request.QueryString["bv"]!=null)
                 btnSendWS.Visible = true;
         }
        ...
        private string TransactionChecking(int i)
        {
            ...
            lblstats.Text = errorMsg.ToString();
        ...
        protected void btnSendWS_Click(object sender, EventArgs e)
        {
            string RegMojaz = PublicFunction.RegWSmojaz(0,Convert.ToInt32( lblEpayID.Text));
            if (RegMojaz != "")
