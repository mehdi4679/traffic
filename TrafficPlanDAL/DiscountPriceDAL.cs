...
{
    public class DiscountPriceClass
    {
        public static SqlConnection cnn = new SqlConnection(CSharp.PublicFunction.cnstr());
        public static int insert(ClDiscountPrice c )

        {

            SqlCommand cmd = new SqlCommand("PRC_DiscountPrice_Insert", cnn);
...
cmd.Parameters.Add(new SqlParameter("DiscountID", SqlDbType.Int)).Value =Securenamespace.SecureData.CheckSecurity(c.DiscountID);
cmd.Parameters.Add(new SqlParameter("Price", SqlDbType.Int)).Value =Securenamespace.SecureData.CheckSecurity(c.Price);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static DataSet GetList(ClDiscountPrice c)
        {

            SqlCommand cmd = new SqlCommand("PRC_DiscountPrice_GetList", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
...
cmd.Parameters.Add(new SqlParameter("Price", SqlDbType.Int)).Value = Securenamespace.SecureData.CheckSecurity(c.Price);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static int Update(ClDiscountPrice c)
        {

            SqlCommand cmd = new SqlCommand("PRC_DiscountPrice_Update", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
...
cmd.Parameters.Add(new SqlParameter("Price", SqlDbType.Int)).Value = Securenamespace.SecureData.CheckSecurity(c.Price);
        ...
        //---------------------------------------------------------------------------------------------------------
        public static int Delete(string  DiscountPriceID)
        {

            SqlCommand cmd = new SqlCommand("PRC_DiscountPrice_Delete", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
        cmd.Parameters.Add(new SqlParameter("UserIDLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetUserID();
        cmd.Parameters.Add(new SqlParameter("IpLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetIPAddress();
        cmd.Parameters.Add(new SqlParameter("OSLog", SqlDbType.NVarChar)).Value = CSharp.PublicFunction.GetOS();
   	...
   	cmd.Parameters.Add(new SqlParameter("DiscountPriceID", SqlDbType.Int)).Value =DiscountPriceID ;
